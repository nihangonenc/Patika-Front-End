...
categories = categories.reduce((acc, item) => { // reduce metodu 1 kere yazdırır.
...
function showMenu(menuObj) { 
  ...
  let filterObj = menuObj.map((item) => {  
    return `
  ...
  sectionCenterDOM.innerHTML = filterObj.join(""); 
}
showMenu(menu); 
